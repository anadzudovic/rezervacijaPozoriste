  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM predstava WHERE id=5";
     ...
     <img src="slike/petarpan1.jpg" style="height: 100% ">
      <img src ="slike/petarpan2.jpg"  style="height: 100%">
      
      <img src="slike/petarpan3.jpg"  style="height: 100% ">
      <img src="slike/petarpan4.jpg"  style="height: 100%">
