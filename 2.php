  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM predstava WHERE id=2";
     ...
     <img src="slike/aladin1.jpg" style="height: 100% ">
      <img src ="slike/aladin2.jpg"  style="height: 100%">
      
      <img src="slike/aladin3.jpg"  style="height: 100% ">
      <img src="slike/aladin4.jpg"  style="height: 100%">
