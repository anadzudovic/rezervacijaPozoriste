  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM predstava WHERE id=6";
     ...
     <img src="slike/lepotica1.jpg" style="height: 100% ">
      <img src ="slike/lepotica2.jpg"  style="height: 100%">
      
      <img src="slike/lepotica3.jpg"  style="height: 100% ">
      <img src="slike/lepotica4.jpg"  style="height: 100%">
