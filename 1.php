  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM predstava WHERE id=1";
     ...
     <img src="slike/dedamraz1.jpg" style="height: 100% ">
      <img src ="slike/dedamraz2.jpeg"  style="height: 100%">
      
      <img src="slike/dedamraz3.jpg"  style="height: 100% ">
      <img src="slike/dedamraz4.jpg"  style="height: 100%">
