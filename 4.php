  ...
  <body>
   ...
   <?php 
    ...
    include "konekcija.php";
                $sql="SELECT * FROM predstava WHERE id=4";
     ...
     <img src="slike/pepeljuga1.jpg" style="height: 100% ">
      <img src ="slike/pepeljuga2.jpg"  style="height: 100%">
      
      <img src="slike/pepeljuga3.png"  style="height: 100% ">
      <img src="slike/pepeljuga4.jpg"  style="height: 100%">
